...
const placeBirth = document.querySelector('#placeBirth');
const singleMar = document.querySelector('#singleMar');
...
//   ! Create variables from the form inside of the event listener
  ...
  const nameInput = document.querySelector('#inputEmail4').value;
  const surnameInput = document.querySelector('#inputPassword4').value;
